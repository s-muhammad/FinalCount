...
@section('title', 'گفتگو جدید')
@section('header', 'ایجاد گفتگو جدید')
            ...
            <div class="bg-white rounded-xl shadow-sm p-6" x-data="{ lang: 'fa' }">
                ...
                <div class="space-y-4" x-show="lang === 'fa'">
                    ...
                    <div>
                        ...
                        <input type="text" name="guest_name" value="{{ old('guest_name') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="body" rows="8" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">{{ old('body') }}</textarea>
                    </div>
                </div>
                ...
                <div class="space-y-4" x-show="lang === 'ar'" dir="rtl">
                    ...
                    <div>
                        ...
                        <input type="text" name="guest_name_ar" value="{{ old('guest_name_ar') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="body_ar" rows="8" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">{{ old('body_ar') }}</textarea>
                    </div>
                </div>
                ...
                <div class="space-y-4" x-show="lang === 'en'" dir="ltr">
                    ...
                    <div>
                        ...
                        <input type="text" name="guest_name_en" value="{{ old('guest_name_en') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="body_en" rows="8" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">{{ old('body_en') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="url" name="video_url" value="{{ old('video_url') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary" placeholder="https://...">
                    </div>
                    <div>
