    ...
    <div class="flex min-h-screen">
        ...
        >
            ...
            <nav class="mt-4 px-2">
                ...
                <a href="{{ route('admin.people.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-white/10 transition {{ request()->routeIs('admin.people.*') ? 'bg-white/10' : '' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                    <span x-show="sidebarOpen || mobileSidebar" x-cloak class="text-sm">چهره‌ها و شهدا</span>
                </a>
                ...
                <div class="mt-4 mb-2 px-3" x-show="sidebarOpen || mobileSidebar" x-cloak>
                    <span class="text-xs text-white/50 uppercase tracking-wider">ابزارها</span>
                </div>

                <a href="{{ route('admin.rss.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-white/10 transition {{ request()->routeIs('admin.rss.*') ? 'bg-white/10' : '' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 5c7.18 0 13 5.82 13 13M6 11a7 7 0 017 7m-6 0a1 1 0 11-2 0 1 1 0 012 0z"/></svg>
                    <span x-show="sidebarOpen || mobileSidebar" x-cloak class="text-sm">خبرخوان RSS</span>
                </a>
        ...
        <div class="flex-1 min-w-0">
            ...
            <header class="bg-white shadow-sm sticky top-0 z-30">
                <div class="flex items-center justify-between px-4 md:px-6 h-16">
                    ...
                    <div class="flex items-center gap-4">
                        <a href="/" target="_blank" class="sm:flex text-sm text-gray-600 hover:text-primary items-center gap-1">
