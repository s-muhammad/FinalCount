            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="relative">
                ...
                <div class="hidden peer-checked/fa:block p-8 space-y-6 animate-fade-in">
                    ...
                    <div>
                        ...
                        <input type="text" name="name[fa]" value="{{ old('name.fa') }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 text-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition duration-300" placeholder="عنوان مقاله را وارد کنید">
                    </div>

                    <div>
                        <label class="block text-gray-700 text-sm font-medium mb-2">توضیحات </label>
                        <textarea name="description[fa]" rows="8" class="mytextarea w-full px-4 py-3 rounded-lg border border-gray-300 text-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition duration-300">{{ old('description.fa') }}</textarea>
                    </div>
                </div>
                ...
                <div class="hidden peer-checked/ar:block p-8 space-y-6 animate-fade-in">
                    ...
                    <div>
                        <label class="block text-gray-700 text-sm font-medium mb-2">عنوان </label>
                        <input type="text" name="name[ar]" value="{{ old('name.ar') }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 text-sm focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition duration-300" placeholder="أدخل العنوان هنا">
                    </div>

                    <div>
                        <label class="block text-gray-700 text-sm font-medium mb-2">التوضیحات </label>
                        <textarea name="description[ar]" rows="8" class="mytextarea w-full px-4 py-3 rounded-lg border border-gray-300 text-sm focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition duration-300">{{ old('description.ar') }}</textarea>
                    </div>
                </div>
                ...
                <div class="hidden peer-checked/en:block p-8 space-y-6 animate-fade-in" dir="ltr">
                    ...
                    <div>
                        ...
                        <input type="text" name="name[en]" value="{{ old('name.en') }}" class="w-full px-4 py-3 rounded-lg border border-gray-300 text-sm focus:border-green-500 focus:ring-4 focus:ring-green-100 transition duration-300 text-left" placeholder="Enter title">
                    </div>

                    <div>
                        <label class="block text-gray-700 text-sm font-medium mb-2 text-left"> Description</label>
                        <textarea name="description[en]" rows="8" class="mytextarea w-full px-4 py-3 rounded-lg border border-gray-300 text-sm focus:border-green-500 focus:ring-4 focus:ring-green-100 transition duration-300 text-left">{{ old('description.en') }}</textarea>
                    </div>
                </div>

                {{-- ۳. بخش تنظیمات عمومی (تصویر و تاگل‌های مدرن) --}}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-md transition duration-300 flex flex-col justify-center">
                            ...
                            <div class="flex items-center space-x-4 space-x-reverse">
                                <div class="w-14 h-14 bg-blue-50 rounded-lg flex items-center justify-center text-blue-500 border border-blue-100 shadow-sm shrink-0">
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-md transition duration-300">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="is_in_menu" value="1" class="sr-only peer" {{ old('is_in_menu') == '1' ? 'checked' : '' }}>
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-md transition duration-300">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="is_on_homepage" value="1" class="sr-only peer" {{ old('is_on_homepage') == '1' ? 'checked' : '' }}>
                ...
                <div class="px-8 py-6 bg-gray-100 border-t border-gray-200 flex justify-between items-center rounded-b-2xl">
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-xl shadow-lg shadow-blue-500/30 transition duration-300 transform hover:scale-[1.02] flex items-center gap-2">
