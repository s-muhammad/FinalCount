            ...
            <div class="bg-white rounded-xl shadow-sm p-6" x-data="{ lang: 'fa' }">
                ...
                <div class="space-y-4">
                    ...
                    <div x-show="lang === 'ar'">
                        ...
                        <input type="text" name="title_ar" value="{{ old('title_ar') }}" dir="rtl" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">
                    </div>
                    <div x-show="lang === 'en'">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Title (English)</label>
                        <input type="text" name="title_en" value="{{ old('title_en') }}" dir="ltr" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">
                    </div>
                    ...
                    <div x-show="lang === 'ar'">
                        ...
                        <textarea name="summary_ar" rows="3" dir="rtl" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">{{ old('summary_ar') }}</textarea>
                    </div>
                    <div x-show="lang === 'en'">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Summary (English)</label>
                        <textarea name="summary_en" rows="3" dir="ltr" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">{{ old('summary_en') }}</textarea>
                    </div>

                    <div x-show="lang === 'fa'">
                        <label class="block text-sm font-medium text-gray-700 mb-1">متن</label>
                        <textarea name="body" rows="12" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">{{ old('body') }}</textarea>
                    </div>
                    <div x-show="lang === 'ar'">
                        <label class="block text-sm font-medium text-gray-700 mb-1">متن (عربی)</label>
                        <textarea name="body_ar" rows="12" dir="rtl" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">{{ old('body_ar') }}</textarea>
                    </div>
                    <div x-show="lang === 'en'">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Body (English)</label>
                        <textarea name="body_en" rows="12" dir="ltr" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">{{ old('body_en') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="w-4 h-4 text-primary rounded border-gray-300">
