...
@section('title', 'نقل‌قول جدید')
@section('header', 'ایجاد نقل‌قول جدید')
        ...
        <div class="space-y-4">
            ...
            <div x-show="lang === 'fa'">
                <div>
                    ...
                    <textarea name="body" rows="4" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary" required>{{ old('body') }}</textarea>
                </div>
                <div class="mt-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">منبع</label>
                    <input type="text" name="source" value="{{ old('source') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">
                </div>
            </div>
            ...
            <div x-show="lang === 'ar'">
                <div>
                    ...
                    <textarea name="body_ar" rows="4" dir="rtl" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">{{ old('body_ar') }}</textarea>
                </div>
                <div class="mt-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">المصدر</label>
                    <input type="text" name="source_ar" value="{{ old('source_ar') }}" dir="rtl" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">
                </div>
            </div>
            ...
            <div x-show="lang === 'en'">
                <div>
                    ...
                    <textarea name="body_en" rows="4" dir="ltr" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">{{ old('body_en') }}</textarea>
                </div>
                <div class="mt-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Source</label>
                    <input type="text" name="source_en" value="{{ old('source_en') }}" dir="ltr" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary">
                </div>
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">تاریخ</label>
                <input type="text" name="date" value="{{ old('date') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary" placeholder="1398/01/01">
            </div>
            <div>
